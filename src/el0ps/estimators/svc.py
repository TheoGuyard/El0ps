...
class L0SVC(BaseL0SVC):
    r"""Sparse SVC with L0-norm regularization. The formulation includes a
    Big-M constraint to enable mixed-integer programming solution methods.
...
class L0L1SVC(BaseL0SVC):
    r"""Sparse SVC with L0L1-norm regularization. The formulation can include a
