...
class L0L1L2Classifier(L0Estimator, LinearClassifierMixin):
    r"""Scikit-learn-compatible `linear model <https://scikit-learn.org/stable/api/sklearn.linear_model.html>`_
    classification estimators with L0L1L2-regularization.
    ...
    where :math:`f` is a :class:`el0ps.datafit.Logistic` function,
...
class L0Classifier(L0L1L2Classifier):
    """Substitute for :class:`L0L1L2Classifier` with parameters ``alpha=0``
    and ``beta=0``."""
...
class L0L1Classifier(L0L1L2Classifier):
    """Substitute for :class:`L0L1L2Classifier` with parameter ``beta=0``."""
...
class L0L2Classifier(L0L1L2Classifier):
    """Substitute for :class:`L0L1L2Classifier` with parameter ``alpha=0``."""
